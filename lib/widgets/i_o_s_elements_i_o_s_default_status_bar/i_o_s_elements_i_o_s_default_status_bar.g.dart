...
class IOSElementsIOSDefaultStatusBar extends StatefulWidget {
  final BoxConstraints constraints;

  const IOSElementsIOSDefaultStatusBar(
    this.constraints, {
    Key? key,
  }) : super(key: key);
  @override
  _IOSElementsIOSDefaultStatusBar createState() =>
      _IOSElementsIOSDefaultStatusBar();
}

class _IOSElementsIOSDefaultStatusBar
    extends State<IOSElementsIOSDefaultStatusBar> {
  _IOSElementsIOSDefaultStatusBar();
    ...
    return Container(
        ...
        child: Stack(children: [
          Positioned(
            ...
            height: 35.0,
            child: Container(
                width: widget.constraints.maxWidth * 0.905,
                height: widget.constraints.maxHeight * 0.795,
                decoration: BoxDecoration(),
                child: Stack(children: [
                  Positioned(
                    left: 272.667,
                  ...
                  Positioned(
                    ...
                    child: SvgPicture.asset(
                      ...
                      package: 'kkdds',
                      width: widget.constraints.maxWidth * 0.584,
                      height: widget.constraints.maxHeight * 0.682,
                      fit: BoxFit.none,
                    ),
                  ),
                  Positioned(
